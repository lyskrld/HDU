...
* for usage documentation, see: OGR (vector)  - https://gdal.org/programs/index.html#vector-programs
                                GDAL (raster) - https://gdal.org/programs/index.html#raster-programs