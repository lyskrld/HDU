...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_mapscript')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_mapscript')
...
class intarray(_object):
    ...
    if _newclass:
        ...
        frompointer = _mapscript.intarray_frompointer
...
class CompositingFilter(_object):
    ...
    __swig_setmethods__["next"] = _mapscript.CompositingFilter_next_set
    __swig_getmethods__["next"] = _mapscript.CompositingFilter_next_get
    if _newclass:
        next = _swig_property(_mapscript.CompositingFilter_next_get, _mapscript.CompositingFilter_next_set)
...
class styleObj(_object):
    ...
    if _newclass:
        symbolname = _swig_property(_mapscript.styleObj_symbolname_get)
...
class classObj(_object):
    ...
    if _newclass:
        numlabels = _swig_property(_mapscript.classObj_numlabels_get)
    ...
    if _newclass:
        leader = _swig_property(_mapscript.classObj_leader_get)
...
class scalebarObj(_object):
    ...
    __swig_setmethods__["offsetx"] = _mapscript.scalebarObj_offsetx_set
    __swig_getmethods__["offsetx"] = _mapscript.scalebarObj_offsetx_get
    if _newclass:
        offsetx = _swig_property(_mapscript.scalebarObj_offsetx_get, _mapscript.scalebarObj_offsetx_set)
    __swig_setmethods__["offsety"] = _mapscript.scalebarObj_offsety_set
    __swig_getmethods__["offsety"] = _mapscript.scalebarObj_offsety_get
    if _newclass:
        offsety = _swig_property(_mapscript.scalebarObj_offsety_get, _mapscript.scalebarObj_offsety_set)
...
class layerObj(_object):
    ...
    __swig_setmethods__["connectionoptions"] = _mapscript.layerObj_connectionoptions_set
    __swig_getmethods__["connectionoptions"] = _mapscript.layerObj_connectionoptions_get
    if _newclass:
        connectionoptions = _swig_property(_mapscript.layerObj_connectionoptions_get, _mapscript.layerObj_connectionoptions_set)
...
class mapObj(_object):
    ...
    def getLayerOrder(self):
        """
        getLayerOrder(mapObj self) -> PyObject *
...
class shapeObj(_object):
    ...
    if _newclass:
        ...
        fromWKT = _mapscript.shapeObj_fromWKT
...
msIO_getAndStripStdoutBufferMimeHeaders = _mapscript.msIO_getAndStripStdoutBufferMimeHeaders
